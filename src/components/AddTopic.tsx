...
const AddTopic = () => {
  ...
  return (
    <motion.div
      ...
      <h1 className="text-2xl sm:text-4xl font-bold text-white drop-shadow-md uppercase flex justify-between items-center"><span>Thêm chủ đề</span><Link to="/home"><FaHome /></Link></h1>
